...
const App = () => {
  ...
  const [noData,setNoData]=useState('No información')
  const [searchTerm,setSearchTerm]=useState('')
  const [weatherData,setWeatherData]=useState([])
  const [city,setCity]=useState('Ciudad desconocida')
      ...
      <div className="flex w-3/4 min-h-full rounded-3xl shadow-lg m-auto bg-gray-100">
        ...
        <div className="form-container">
          ...
          <div className="flex flex-col items-center justify-center h-full">
            <h1 className="text-white text-2xl">No encontrás una mejor app del Clima</h1>
